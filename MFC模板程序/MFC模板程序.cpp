...
BEGIN_MESSAGE_MAP(CMFC模板程序App, CWinAppEx)
	ON_COMMAND(ID_APP_ABOUT, &CMFC模板程序App::OnAppAbout)
	// 依據文件命令的標準檔案
...
CMFC模板程序App::CMFC模板程序App()
{
	...
	SetAppID(_T("MFC模板程序.AppID.NoVersion"));

	// TODO: 在此加入建構程式碼，
	// 將所有重要的初始設定加入 InitInstance 中
}

// 僅有的一個 CMFC模板程序App 物件
...
BOOL CMFC模板程序App::InitInstance()
{
	...
	pDocTemplate = new CSingleDocTemplate(
		IDR_MAINFRAME,
		RUNTIME_CLASS(CMFC模板程序Doc),
		RUNTIME_CLASS(CMainFrame),       // 主 SDI 框架視窗
		RUNTIME_CLASS(CMFC模板程序View));
	if (!pDocTemplate)
		return FALSE;
...
// 執行對話方塊的應用程式命令
void CMFC模板程序App::OnAppAbout()
{
	CAboutDlg aboutDlg;
	aboutDlg.DoModal();
}

// CMFC模板程序App 自訂載入/儲存方法

void CMFC模板程序App::PreLoadState()
{
	BOOL bNameValid;
	CString strName;
...
void CMFC模板程序App::LoadCustomState()
{
}

void CMFC模板程序App::SaveCustomState()
{
}
